...
public class LotteryViewController implements Initializable {
    
//<editor-fold defaultstate="collapsed" desc="Class Variebles">
    private final int MAX = 89;  // final névadási konvencio nagybetűvel írni
    ...
    private final String WIN2= "Kettesed van a lottón, sajnos ez csak egy mosolyra elég.:)";
...
private void handleAlertButton(ActionEvent event ){
    ...
    System.out.println("Rám kattintottál");
}
